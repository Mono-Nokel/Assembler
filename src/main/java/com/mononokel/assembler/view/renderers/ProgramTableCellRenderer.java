...
package com.mononokel.assembler.view.renderers;
...
public class ProgramTableCellRenderer extends DefaultTableCellRenderer
{
         ...
         int row, int column)
   {
      ...
      ValidLine valid = model.getValid(row, column);
      ((JLabel)c).setIcon(valid.icon);
      ((JLabel)c).setToolTipText(valid.errorMessage);
